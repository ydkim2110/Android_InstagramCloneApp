...
public class NextActivity extends AppCompatActivity {
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (intent.hasExtra(getString(R.string.selected_image))) {
                    ...
                    mFirebaseMethods.uploadNewPhoto(getString(R.string.new_photo), captipn, imageCount, imageURL, null);
                } else if (intent.hasExtra(getString(R.string.selected_bitmap))) {
                    bitmap = (Bitmap) intent.getParcelableExtra(getString(R.string.selected_bitmap));
                    mFirebaseMethods.uploadNewPhoto(getString(R.string.new_photo), captipn, imageCount, null, bitmap);
                }
    ...
    private void setImage() {
        ...
        if (intent.hasExtra(getString(R.string.selected_image))) {
            imageURL = intent.getStringExtra(getString(R.string.selected_image));
            Log.d(TAG, "setImage: got new imageURL: " + imageURL);
