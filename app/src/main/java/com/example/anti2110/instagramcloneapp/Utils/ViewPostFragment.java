...
public class ViewPostFragment extends Fragment {
                ...
                for(DataSnapshot singleSnapshot : dataSnapshot.getChildren()){
                    ...
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Log.d(TAG, "onDataChange: getLikesString: " + mUsers.toString());
                            Log.d(TAG, "onDataChange: mUserAccountSettings.getUsername(): " + mUserAccountSettings.getUsername());
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    for (DataSnapshot singleSnapshot : dataSnapshot.getChildren()) {
                        ...
                        Log.d(TAG, "onDoubleTap: mLikedByCurrentUser: " + mLikedByCurrentUser);
                        Log.d(TAG, "onDoubleTap: getUser_id: " + singleSnapshot.getValue(Like.class).getUser_id());
    ...
    private void getPhotoDetails() {
        Log.d(TAG, "getPhotoDetails: started.");
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference();
        Query query = reference
    ...
    /**
     * retrieve activity number from the incoming bundle from profileActivity interface
     * @return
     */
