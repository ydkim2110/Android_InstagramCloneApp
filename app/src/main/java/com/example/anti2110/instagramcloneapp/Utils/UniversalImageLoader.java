...
public class UniversalImageLoader {
     ...
     * are being changed in the Fragment/Activity OR if the are being set in a list or a grid.
     * @param imageURL
     * @param image
     * @param mProgressBar
     * @param append
     */
    public static void setImages(String imageURL, ImageView image, final ProgressBar mProgressBar, String append) {
